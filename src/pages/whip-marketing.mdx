...
Hiệu ứng trong Whip bám vào **nội dung semantic** — từng từ, từng cử chỉ, từng biểu cảm — không bám vào giây cụ thể. Cắt clip, đảo thứ tự, sửa lại câu → animation tự theo. Không bao giờ phải sửa tay lại.
